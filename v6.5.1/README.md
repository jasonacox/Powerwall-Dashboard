# Powerwall-Dashboard - Grafana v6.5.1 (Archive)

Monitoring Dashboard for the Tesla Powerwall using Grafana, InfluxDB, Telegraf and pyPowerwall. This is an archive of the legacy Grafana v6.5.1 setup.
